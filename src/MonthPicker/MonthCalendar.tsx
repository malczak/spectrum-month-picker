...
const Months = [
    { area: 'Jan', label: 'January' },
    { area: 'Fab', label: 'February' },
    { area: 'Mar', label: 'March' },
    { area: 'Apr', label: 'April' },
    { area: 'May', label: 'May' },
    { area: 'Jun', label: 'June' },
    { area: 'Jul', label: 'July' },
    { area: 'Aug', label: 'August' },
    { area: 'Sep', label: 'September' },
    { area: 'Oct', label: 'October' },
    { area: 'Nov', label: 'November' },
    { area: 'Dec', label: 'December' },
];
            ...
            <Flex flex="1" justifyContent="center">
                <Heading
                    ...
                    {monthDateFormatter.format(
                        currentMonth.toDate(state.timeZone)
                    )}
                </Heading>
            </Flex>
            <ActionButton
